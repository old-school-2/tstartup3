<section class="banner banner-style-1">
            ...
            <ul class="list-unstyled shape-group-21">
                <li class="shape shape-1" data-sal="slide-down" data-sal-duration="500" data-sal-delay="100">
                    <img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-39.png" alt="Bubble">
                </li>
                <li class="shape shape-2" data-sal="zoom-in" data-sal-duration="800" data-sal-delay="500">
                    <img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-38.png" alt="Bubble">
                </li>
                <li class="shape shape-3" data-sal="slide-left" data-sal-duration="500" data-sal-delay="700">
                    <img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-14.png" alt="Bubble">
                </li>
                ...
                <li class="shape shape-6" data-sal="slide-left" data-sal-duration="500" data-sal-delay="700">
                    <img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-40.png" alt="Bubble">
                </li>
                <li class="shape shape-7" data-sal="slide-left" data-sal-duration="500" data-sal-delay="700">
                    <img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-41.png" alt="Bubble">
                </li>
            </ul>
        </section>
        ...
        <section class="section section-padding-2 bg-color-dark">
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100">
                        <div class="services-grid active">
                            <div class="thumbnail">
                                <img src="<?=DOMAIN;?>/tmp/assets/media/icon/icon-1.png" alt="icon">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xl-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="200">
                        <div class="services-grid">
                            <div class="thumbnail">
                                <img src="<?=DOMAIN;?>/tmp/assets/media/icon/icon-2.png" alt="icon">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xl-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                        <div class="services-grid">
                            <div class="thumbnail">
                                <img src="<?=DOMAIN;?>/tmp/assets/media/icon/icon-3.png" alt="icon">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xl-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100">
                        <div class="services-grid">
                            <div class="thumbnail">
                                <img src="<?=DOMAIN;?>/tmp/assets/media/icon/icon-4.png" alt="icon">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xl-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="200">
                        <div class="services-grid">
                            <div class="thumbnail">
                                <img src="<?=DOMAIN;?>/tmp/assets/media/icon/icon-5.png" alt="icon">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-xl-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                        <div class="services-grid">
                            <div class="thumbnail">
                                <img src="<?=DOMAIN;?>/tmp/assets/media/icon/icon-6.png" alt="icon">
                            </div>
                            <div class="content">
            ...
            <ul class="list-unstyled shape-group-10">
                <li class="shape shape-1"><img src="<?=DOMAIN;?>/tmp/assets/media/others/line-9.png" alt="Circle"></li>
                <li class="shape shape-2"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-42.png" alt="Circle"></li>
                <li class="shape shape-3"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-43.png" alt="Circle"></li>
            </ul>
        </section>
        <!--=====================================-->
                        ...
                        <div class="slick-slider slick-dot-nav featured-thumbnail" data-slick='{"infinite": true,"arrows": false, "dots": false, "fade": true, "slidesToShow": 1, "asNavFor": ".featured-content"}'>
                            <div class="slick-slide">
                                <div class="case-study-featured-thumb">
                                    <img src="<?=DOMAIN;?>/tmp/assets/media/others/case-study-4.png" alt="travel">
                                </div>
                            </div>
                            <div class="slick-slide">
                                <div class="case-study-featured-thumb">
                                    <img src="<?=DOMAIN;?>/tmp/assets/media/others/case-study-5.png" alt="travel">
                                </div>
                            </div>
                            <div class="slick-slide">
                                <div class="case-study-featured-thumb">
                                    <img src="<?=DOMAIN;?>/tmp/assets/media/others/case-study-6.png" alt="travel">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="section section-padding-equal bg-color-light">
            ...
            <ul class="shape-group-6 list-unstyled">
                <li class="shape shape-1"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-7.png" alt="Bubble"></li>
                <li class="shape shape-2"><img src="<?=DOMAIN;?>/tmp/assets/media/others/line-4.png" alt="line"></li>
                <li class="shape shape-3"><img src="<?=DOMAIN;?>/tmp/assets/media/others/line-5.png" alt="line"></li>
            </ul>
        </section>
        <!--=====================================-->
        <!--=        Project Area Start         =-->
        ...
        <section class="section section-padding-2">
                    ...
                    <div class="row row-35 isotope-list">
                            ...
                            <div class="project-grid">
                                <div class="thumbnail">
                                    <a href="single-portfolio.html">
                                        <img src="<?=DOMAIN;?>/tmp/assets/media/project/project-1.png" alt="project">
                                    </a>
                                </div>
                                <div class="content">
                        ...
                        <div class="col-md-6 project mobile">
                            <div class="project-grid">
                                <div class="thumbnail">
                                    <a href="single-portfolio.html">
                                        <img src="<?=DOMAIN;?>/tmp/assets/media/project/project-2.png" alt="project">
                                    </a>
                                </div>
                                <div class="content">
                        ...
                        <div class="col-md-6 project branding">
                            <div class="project-grid">
                                <div class="thumbnail">
                                    <a href="single-portfolio.html">
                                        <img src="<?=DOMAIN;?>/tmp/assets/media/project/project-3.png" alt="project">
                                    </a>
                                </div>
                                <div class="content">
                        ...
                        <div class="col-md-6 project mobile">
                            <div class="project-grid">
                                <div class="thumbnail">
                                    <a href="single-portfolio.html">
                                        <img src="<?=DOMAIN;?>/tmp/assets/media/project/project-4.png" alt="project">
                                    </a>
                                </div>
                                <div class="content">
                        ...
                        <div class="col-md-6 project branding">
                            <div class="project-grid">
                                <div class="thumbnail">
                                    <a href="single-portfolio.html">
                                        <img src="<?=DOMAIN;?>/tmp/assets/media/project/project-5.png" alt="project">
                                    </a>
                                </div>
                                <div class="content">
                        ...
                        <div class="col-md-6 project mobile">
                            <div class="project-grid">
                                <div class="thumbnail">
                                    <a href="single-portfolio.html">
                                        <img src="<?=DOMAIN;?>/tmp/assets/media/project/project-6.png" alt="project">
                                    </a>
                                </div>
                                <div class="content">
            ...
            <ul class="shape-group-7 list-unstyled">
                <li class="shape shape-1"><img src="<?=DOMAIN;?>/tmp/assets/media/others/circle-2.png" alt="circle"></li>
                <li class="shape shape-2"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-2.png" alt="Line"></li>
                <li class="shape shape-3"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-1.png" alt="Line"></li>
            </ul>
        </section>
        <!--=====================================-->
                ...
                <div class="row">
                    <div class="col-lg-3 col-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100">
                        <div class="counterup-progress active">
                            <div class="icon">
                                <img src="<?=DOMAIN;?>/tmp/assets/media/icon/icon-7.png" alt="Apple">
                            </div>
                    ...
                    <div class="col-lg-3 col-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="200">
                        <div class="counterup-progress">
                            <div class="icon">
                                <img src="<?=DOMAIN;?>/tmp/assets/media/icon/icon-8.png" alt="Apple">
                            </div>
                            <div class="count-number h2">
                    ...
                    <div class="col-lg-3 col-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                        <div class="counterup-progress">
                            <div class="icon">
                                <img src="<?=DOMAIN;?>/tmp/assets/media/icon/icon-9.png" alt="Apple">
                            </div>
                            <div class="count-number h2">
                    ...
                    <div class="col-lg-3 col-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="400">
                        <div class="counterup-progress">
                            <div class="icon">
                                <img src="<?=DOMAIN;?>/tmp/assets/media/icon/apple.png" alt="Apple">
                            </div>
                            <div class="count-number h2">
        ...
        <section class="section section-padding">
                ...
                <div class="row">
                    <div class="col-lg-4" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="100">
                        <div class="testimonial-grid active">
                            <span class="social-media"><img src="<?=DOMAIN;?>/tmp/assets/media/icon/yelp-2.png" alt="Yelp"></span>
                            ...
                            <div class="author-info">
                                <div class="thumb">
                                    <img src="<?=DOMAIN;?>/tmp/assets/media/testimonial/testimonial-1.png" alt="Google Review">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-4" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="200">
                        <div class="testimonial-grid">
                            <span class="social-media"><img src="<?=DOMAIN;?>/tmp/assets/media/icon/google-2.png" alt="google"></span>
                            <p>“ Donec metus lorem, vulputate
                                at sapien sit amet, auctor iaculis lorem. In vel hendrerit nisi. Vestibulum eget risus velit. ”</p>
                            <div class="author-info">
                                <div class="thumb">
                                    <img src="<?=DOMAIN;?>/tmp/assets/media/testimonial/testimonial-2.png" alt="Google Review">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-4" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="300">
                        <div class="testimonial-grid">
                            <span class="social-media"><img src="<?=DOMAIN;?>/tmp/assets/media/icon/fb-2.png" alt="Facebook"></span>
                            <p>“ Donec metus lorem, vulputate
                                at sapien sit amet, auctor iaculis lorem. In vel hendrerit nisi. Vestibulum eget risus velit. ”</p>
                            <div class="author-info">
                                <div class="thumb">
                                    <img src="<?=DOMAIN;?>/tmp/assets/media/testimonial/testimonial-3.png" alt="Google Review">
                                </div>
                                <div class="content">
            ...
            <ul class="shape-group-4 list-unstyled">
                <li class="shape-1"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-1.png" alt="Bubble"></li>
            </ul>
        </section>
        <!--=====================================-->
        <!--=        Pricing Area Start       	=-->
        ...
        <section class="section bg-color-light section-padding">
            ...
            <ul class="shape-group-3 list-unstyled">
                <li class="shape shape-1"><img src="<?=DOMAIN;?>/tmp/assets/media/others/line-1.png" alt="shape"></li>
                <li class="shape shape-2"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-4.png" alt="shape"></li>
            </ul>
        </section>
        <!--=====================================-->
        <!--=        Brand Area Start       	=-->
        ...
        <section class="section section-padding-equal">
                ...
                <div class="row g-0">
                    <div class="col-xl-6" data-sal="slide-right" data-sal-duration="800" data-sal-delay="100">
                        <div class="blog-list active">
                            <div class="post-thumbnail">
                                <a href="single-blog-2.html"><img src="<?=DOMAIN;?>/tmp/assets/media/blog/blog-1.png" alt="Blog Post"></a>
                            </div>
                    ...
                    <div class="col-xl-6" data-sal="slide-left" data-sal-duration="800" data-sal-delay="100">
                        <div class="blog-list border-start">
                            <div class="post-thumbnail">
                                <a href="single-blog-3.html"><img src="<?=DOMAIN;?>/tmp/assets/media/blog/blog-2.png" alt="Blog Post"></a>
                            </div>
                            <div class="post-content">
            ...
            <ul class="shape-group-1 list-unstyled">
                <li class="shape shape-1"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-1.png" alt="bubble"></li>
                <li class="shape shape-2"><img src="<?=DOMAIN;?>/tmp/assets/media/others/line-1.png" alt="bubble"></li>
                <li class="shape shape-3"><img src="<?=DOMAIN;?>/tmp/assets/media/others/line-2.png" alt="bubble"></li>
                <li class="shape shape-4"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-2.png" alt="bubble"></li>
            </ul>
        </section>
        <!--=====================================-->
        ...
        <section class="section call-to-action-area">
                ...
                <div class="call-to-action">
                    ...
                    <div class="thumbnail">
                        <div class="larg-thumb" data-sal="zoom-in" data-sal-duration="600" data-sal-delay="100">
                            <img class="paralax-image" src="<?=DOMAIN;?>/tmp/assets/media/others/chat-group.png" alt="Chat">
                        </div>
                        <ul class="list-unstyled small-thumb">
                            <li class="shape shape-1" data-sal="slide-right" data-sal-duration="800" data-sal-delay="400">
                                <img class="paralax-image" src="<?=DOMAIN;?>/tmp/assets/media/others/laptop-poses.png" alt="Laptop">
                            </li>
                            <li class="shape shape-2" data-sal="slide-left" data-sal-duration="800" data-sal-delay="300">
                                <img class="paralax-image" src="<?=DOMAIN;?>/tmp/assets/media/others/bill-pay.png" alt="Bill">
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <ul class="list-unstyled shape-group-9">
                <li class="shape shape-1"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-12.png" alt="Comments"></li>
                <li class="shape shape-2"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-16.png" alt="Comments"></li>
                <li class="shape shape-3"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-13.png" alt="Comments"></li>
                <li class="shape shape-4"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-14.png" alt="Comments"></li>
                <li class="shape shape-5"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-16.png" alt="Comments"></li>
                <li class="shape shape-6"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-15.png" alt="Comments"></li>
                <li class="shape shape-7"><img src="<?=DOMAIN;?>/tmp/assets/media/others/bubble-16.png" alt="Comments"></li>
            </ul>
        </section>